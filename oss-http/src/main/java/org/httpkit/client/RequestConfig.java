...
public class RequestConfig
{
    ...
    public RequestConfig(HttpMethod method, Map<String, Object> headers, Object body, int timeoutMs, int keepAliveMs, String proxy_host,
            int proxy_port, boolean tunnel)
    {
