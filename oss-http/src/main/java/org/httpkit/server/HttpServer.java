...
public class HttpServer implements Runnable
{
    ...
    private final int                               maxBody;                                               // max
                                                                                                           // http
                                                                                                           // body
                                                                                                           // size
    private final int                               maxLine;                                               // max
                                                                                                           // header
                                                                                                           // line
                                                                                                           // size

    private final int                               maxWs;                                                 // websocket,
                                                                                                           // max
                                                                                                           // message
                                                                                                           // size
    ...
    public HttpServer(String ip, int port, IHandler handler, int maxBody, int maxLine, int maxWs, ProxyProtocolOption proxyProtocolOption)
            throws IOException
    {
